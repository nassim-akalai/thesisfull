...
In dieser Header Datei wurde das Messprinzip festgelegt. Es wurde ein \mbox{\glqq{}Sandwich\grqq{}-Muster} angewendet. Jeder Benchmark misst nach demselben Schema.
...
\end{lstlisting}
Der Z{\"a}hler wird direkt vor und direkt nach diesem Vorgang ausgelesen und bildet anschlie{\ss}end die Differenz. Der zu messende Code befindet sich dabei dazwischen, daher die Bezeichnung \mbox{\glqq{}Sandwich\grqq{}-Muster}.
